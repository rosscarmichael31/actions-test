...
# Pull Image
docker pull ghcr.io/world-wide-logistics/"${CONTAINER_NAME}":"${CONTAINER_VERSION}"

# Create Container
docker create --restart always --name "${CONTAINER_NAME}" -p 8080:8080 ghcr.io/world-wide-logistics/"${CONTAINER_NAME}":"${CONTAINER_VERSION}"
